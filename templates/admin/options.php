...
$this -> the_options = array('label-page'	=> array(	'name'		=> __('Button Labels', 'nm-woostore'),
														'type'	=> 'tab',
														'desc'	=> __('Here you can personalized all buttons labels. <a href="http://www.najeebmedia.com/personalized-woostore-guide/#buttons" target="_blank">How it works!</a>', 'nm-woostore'),
														'meat'	=> $meat_labels,
													),

							'cart-page'	=> array(	'name'		=> __('Cart Page', 'nm-woostore'),
														'type'	=> 'tab',
														'desc'	=> __('Here you can personalized cart page areas. <a href="http://www.najeebmedia.com/personalized-woostore-guide/#cart" target="_blank">How it works!</a>', 'nm-woostore'),
														'meat'	=> $meat_cart,
													),
